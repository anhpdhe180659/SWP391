 ...
 * @author admin
 */
@WebServlet(name = "DeleteAmenityDetailConatroller", urlPatterns = {"/deleteAmenityDetail"})
public class DeleteAmenityDetailConatroller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteAmenityDetailConatroller</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteAmenityDetailConatroller at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
