...
<html lang="en">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <form action="editBooking" method="POST" onsubmit="return doSave()">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center">
                                            ...
                                            <div style="display: flex">
                                                ...
                                                <c:set value="${requestScope.paymentMethod}" var="paymentMethod"/>
                                                <div class="col-md-3 col-lg-3">
                                                    <div class="form-group ">
                                                        <label for="paymentMethod">Payment Method</label>
                                                        <select class="form-control" id="paymentMethod" name="paymentMethod">
                                                            <option value="2" ${paymentMethod == 2 ? 'selected' : ''} >Cash</option>
                                                            <option value="1" ${paymentMethod == 1 ? 'selected' : ''} >Online Banking</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        function doSave() {
            ...
            // Trả về true để submit, false để hủy submit
    ...
    <script>
        function FormatDeposit() {
            const value = document.getElementById("neededDeposit").value;
            document.getElementById('formattedDeposit').innerText = new Intl.NumberFormat('vi-VN', {style: 'currency', currency: 'VND'}).format(value);
        }
        const value = document.getElementById("neededDeposit").value;
        document.getElementById('formattedDeposit').innerText = new Intl.NumberFormat('vi-VN', {style: 'currency', currency: 'VND'}).format(value);
