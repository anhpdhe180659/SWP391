                                                        ...
                                                        <c:forEach items="${sessionScope.listRoom}" var="s">
                                                            <tr class="room-row">
                                                                ...
                                                                <td style="text-align: center">
                                                                    <a href="roomItem?id=${s.roomId}">
                                                                        <i class="far fa-eye me-3"></i>&nbsp;&nbsp;View items of room
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </c:forEach>
                                                    ...
                                                    <div class="demo">
                                                        <ul class="pagination pg-primary" style="display: flex; justify-content: flex-end;">
                                                            ...
                                                            <li class="page-item ${index < 2 ? 'disabled' : ''}">
                                                                <a class="page-link" href="listRoomStaff?index=${index - 1}&typeId=${requestScope.typeId}&statusId=${requestScope.statusId}&cleanId=${requestScope.cleanId}" aria-label="Previous">
                                                            ...
                                                            <c:forEach var="p" begin="${startPage}" end="${endPage}">
                                                                <li class="page-item ${index == p ? 'active' : ''}">
                                                                    <a class="page-link" href="listRoomStaff?index=${p}&typeId=${requestScope.typeId}&statusId=${requestScope.statusId}&cleanId=${requestScope.cleanId}">${p}</a>
                                                                </li>
                                                            </c:forEach>
                                                            <li class="page-item ${index < Nopage ? '' : 'disabled'}">
                                                                <a class="page-link" href="listRoomStaff?index=${index + 1}&typeId=${requestScope.typeId}&statusId=${requestScope.statusId}&cleanId=${requestScope.cleanId}" aria-label="Next">
